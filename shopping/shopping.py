...
def load_data(filename):
    ...
    """
    # create two empty lists for evidence and labels
    evidence, labels = [], []
    month_number = {name: num - 1 for num, name in enumerate(calendar.month_abbr) if num}
    ...
    # iterate over reader and append the data to the lists
        for row in reader:
            evidence.append([
